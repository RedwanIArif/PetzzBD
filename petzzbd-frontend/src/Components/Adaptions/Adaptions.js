...
const Adaptions = () => {
    return (
        <div className='center py-10'>
            <div>
            <div className="item_center p-4 adaption">
                <h3 className='text-3xl'>Adaption Form</h3>
            </div>
            ...
            <br />
            <h5>Pet's description:</h5>
            <textarea className='text_field'placeholder="Description"></textarea>
            <br />
            <div className="item_center p-8">
